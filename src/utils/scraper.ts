...
export const MONOSCHINOS_SLUG_MAP: Record<string, string> = {
  ...
  "196218": "ryomin-0-nin-start-no-henkyo-ryoshu-sama",
  ...
  "bleach-sennen-kessenhen": "bleach-sennen-kessen-hen",
  "tioanime-bleach-sennen-kessenhen": "bleach-sennen-kessen-hen",
  "185874": "bleach-sennen-kessen-hen",
  ...
  "tioanime-tensei-shitara-slime-datta-ken-3rd-season": "tensei-shitara-slime-datta-ken-3rd-season",
  "that-time-i-got-reincarnated-as-a-slime-4": "tensei-shitara-slime-datta-ken-4th-season",
  "that-time-i-got-reincarnated-as-a-slime-tv-4": "tensei-shitara-slime-datta-ken-4th-season",
  "tensei-shitara-slime-datta-ken-4": "tensei-shitara-slime-datta-ken-4th-season",
  "tensei-shitara-slime-datta-ken-iv": "tensei-shitara-slime-datta-ken-4th-season",
  "tioanime-tensei-shitara-slime-datta-ken-4th-season": "tensei-shitara-slime-datta-ken-4th-season",
  ...
  "consumet-182205": "tensei-shitara-slime-datta-ken-4th-season",
  ...
  "the-villager-of-level-999": "lv999-no-murabito",
  "the-villager-of-level-999-sub-espanol": "lv999-no-murabito",
  "lv999-no-murabito": "lv999-no-murabito",
  "consumet-197715": "lv999-no-murabito",
  "anilist-197715": "lv999-no-murabito",
  ...
  "consumet-146493": "ragna-crimson",
  "anilist-146493": "ragna-crimson",
  "146493": "ragna-crimson",
  "a-galaxy-next-door": "otonari-ni-ginga",
  "otonari-ni-ginga": "otonari-ni-ginga",
  "consumet-148098": "otonari-ni-ginga",
  "anilist-148098": "otonari-ni-ginga",
  "148098": "otonari-ni-ginga",
  "tomb-raider-king": "toukutsuou",
  "dogul-wang": "toukutsuou",
  "toukutsuou": "toukutsuou",
  "consumet-184356": "toukutsuou",
  "anilist-184356": "toukutsuou",
  "184356": "toukutsuou",
...
export class AnimeApiAggregator {
  static async getAiring(page: number = 1): Promise<Anime[]> {
    ...
    return local.length > 0 ? local : getAnimesWithEpisodes().slice(0, 24);
  }

  static async getFinished(page: number = 1): Promise<Anime[]> {
    const local = getAnimesWithEpisodes().filter(a => a.status === "Finalizado");
    return local.length > 0 ? local : getAnimesWithEpisodes();
  }

  static async searchMonosChinosDirect(query: string): Promise<Anime[]> {
    const localDb = getAnimesWithEpisodes();
    const lower = query.toLowerCase().trim();
    if (!lower || lower === "todos" || lower === "todas") return localDb;

    return localDb.filter(a => 
      a.title.toLowerCase().includes(lower) || 
      (a.title_romaji && a.title_romaji.toLowerCase().includes(lower)) ||
      (a.title_english && a.title_english.toLowerCase().includes(lower)) ||
      (a.title_native && a.title_native.toLowerCase().includes(lower)) ||
  ...
  static async getMonosChinosMoviesDirect(): Promise<Anime[]> {
    return getAnimesWithEpisodes().filter(a => a.type === "Película");
  }
  ...
  static async getTrending(): Promise<Anime[]> {
    return getAnimesWithEpisodes().slice(0, 20);
  }
  ...
  static async getMovies(genre?: string, page: number = 1): Promise<Anime[]> {
    ...
    if (genre && genre !== "Todas" && genre !== "Todos" && genre.toLowerCase().trim() !== "todos") {
      const lower = genre.toLowerCase().trim();
      const filtered = base.filter(m => m.genres.some(g => g.toLowerCase().includes(lower)) || m.title.toLowerCase().includes(lower));
